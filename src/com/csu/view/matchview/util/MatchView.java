package com.csu.view.matchview.util;
...
public class MatchView extends View {
    ...
    private float mInTime = 0.5f;//划入时间(单位秒)
    private float mOutTime = 0.5f;//划出时间(单位秒)
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int width = getLeftPadding() + mDrawZoneWidth + getRightPadding();
