...
public class MuPDFCore
{
	...
	public native void addWatermarkWithImage(int pageNum,byte[] image,int width,int height,int pageWidth,int pageHeight,int length);
	//Add watermark with text
	public native void addWatermarkWithText(String text);
	//page has watermark or not
	public native int isPageHasWatermark(int pageNum);
	//insert audio
	public native void insertAudio(String sound_path,String icon_path,int pageNum,int x,int y,int pageWidth,int pageHeight);
	//play audio
	public synchronized native byte[] playAudio(int pageNum,int x,int y);
